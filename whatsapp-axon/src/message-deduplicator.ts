 ...
 *
 * When multiple bots receive the same group message via independent Baileys sessions,
...
class MessageDeduplicator {
   ...
   * @param isReprocessed Whether this is a re-processed message
  ...
  shouldEmit(
    ...
    // Re-processed messages always emit
    if (isReprocessed) {
      return true;
    }
...
// Singleton instance shared across all bot instances
